...
def main():
    ...
    model.eval()
    with torch.no_grad():
        rgb = np.array(Image.open('acoustic_avspeech/img/10.png'))
        print(rgb.shape)
        audio, _ = librosa.load('acoustic_avspeech/audio/10.wav',sr=16000)
        audio_length = 40960
        ...
        sf.write('10n.wav', pred.cpu().numpy()[0], 16000)
